<template>
	<div class="recommend">
		<div class="imgs">
			<img src="../../assets/index/la.jpg"/>
		</div>
		<div class="title">
			<span>航拍|用上帝的视角俯视一下你所熟悉的城市</span>
		</div>
...
<script>
	...
	export default{
		...
		mounted(){
			this.$nextTick(() => {
				document.getElementsByClassName('swiperimg-ul')[0].style.width = this.imgList.length * document.getElementsByClassName('swiperimg-ul-li')[0].offsetWidth + parseFloat(window.getComputedStyle(document.getElementsByClassName('swiperimg-ul-li')[0]).marginRight) * (this.imgList.length + 3) + 'px';
			})
		}
	}
</script>
